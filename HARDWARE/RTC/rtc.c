...
//返回值:SUCEE(1),成功
//       ERROR(0),进入初始化模式失败 
HAL_StatusTypeDef RTC_Set_Time(u8 hour,u8 min,u8 sec,u8 sub)
{
	...
	RTC_TimeStructure.SubSeconds=sub;
...
{      
    ...
    { 
        RTC_Set_Time(12,00,00,00);	        //设置时间 ,根据实际时间修改
		RTC_Set_Date(17,10,1);		                    //设置日期
